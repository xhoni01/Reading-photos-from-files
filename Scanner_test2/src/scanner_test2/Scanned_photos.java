 ...
 * @author First-it09
 */
public class Scanned_photos extends javax.swing.JFrame {

    /**
     * Creates new form Scanned_photos
     */
    public Scanned_photos() {
        initComponents();
        getImagesName();
    }
...
{ 
    ...
    private void jTable_ImagesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_ImagesMouseClicked
        ...
        show.setDefaultCloseOperation(Scanned_photos.DISPOSE_ON_CLOSE);
   ...
   try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Scanned_photos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Scanned_photos().setVisible(true);
            }
        });
    }
